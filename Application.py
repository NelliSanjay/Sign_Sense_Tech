...
class Application:
    ...
    def _init_(self):
        ...
        self.json_file = open(f"C:\\Users\\KMK\\OneDrive\\Documents\\project\\aicte Project\\model\\model-bw.json", "r")
        self.model_json = self.json_file.read()
        self.json_file.close()
        self.loaded_model = model_from_json(self.model_json)
        self.loaded_model.load_weights(
            "C:\\Users\\KMK\\OneDrive\\Documents\\project\\aicte Project\\model\\model-bw.h5")

        self.json_file_dru = open(
            "C:\\Users\\KMK\\OneDrive\\Documents\\project\\aicte Project\\model\\model-bw_dru.json", "r")
        self.model_json_dru = self.json_file_dru.read()
        self.json_file_dru.close()
        self.loaded_model_dru = model_from_json(self.model_json_dru)
        self.loaded_model_dru.load_weights(
            "C:\\Users\\KMK\\OneDrive\\Documents\\project\\aicte Project\\model\\model-bw_dru (2).h5")

        self.json_file_tkdi = open(
            "C:\\Users\\KMK\\OneDrive\\Documents\\project\\aicte Project\\model\\model-bw_tkdi.json", "r")
        self.model_json_tkdi = self.json_file_tkdi.read()
        self.json_file_tkdi.close()
        self.loaded_model_tkdi = model_from_json(self.model_json_tkdi)
        self.loaded_model_tkdi.load_weights(
            "C:\\Users\\KMK\\OneDrive\\Documents\\project\\aicte Project\\model\\model-bw_tkdi.h5")

        self.json_file_smn = open(
            "C:\\Users\\KMK\\OneDrive\\Documents\\project\\aicte Project\\model\\model-bw_smn.json", "r")
        self.model_json_smn = self.json_file_smn.read()
        self.json_file_smn.close()
        self.loaded_model_smn = model_from_json(self.model_json_smn)
        self.loaded_model_smn.load_weights(
            "C:\\Users\\KMK\\OneDrive\\Documents\\project\\aicte Project\\model\\model-bw_smn.h5")
    ...
    def video_loop(self):
        ...
        predicts = self.hs.suggest(self.current_symbol)
        k=predicts[0]
        #text_to_speech(k,400,0.5)
        delayed_thread = threading.Thread(target=text_to_speech(k,100,0.7))
...
def text_to_speech(text, rate=400,sleep=2):
    engine = pyttsx3.init()
